...
static void vectorToBlob(const std::vector<float>& vec, std::vector<char>& blob) {
...
static float cosineSimilarity_for_sqlite(const std::vector<float>& v1, const std::vector<float>& v2) {
...
static float cosineSimilarity_for_sqlite_simd(const std::vector<float>& v1, const std::vector<float>& v2) {
...
static void sqliteCosineSimilarity(sqlite3_context* context, int argc, sqlite3_value** argv) {
    if (argc != 2) {
